...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = ('email', 'first_name', 'last_name', 'plan', 'is_active', 'is_staff', 'date_joined')
...
class UserStatsAdmin(admin.ModelAdmin):
    list_display = ('user', 'renders_this_month', 'renders_limit', 'total_projects', 'storage_used_bytes')
    search_fields = ('user__email',)
    raw_id_fields = ('user',)
...
class UserSessionAdmin(admin.ModelAdmin):
    list_display = ('user', 'device_name', 'ip_address', 'created_at', 'last_active', 'is_active')
