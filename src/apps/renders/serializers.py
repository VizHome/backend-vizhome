...
class RenderCreateSerializer(serializers.ModelSerializer):
    ...
    sketch_base64 = serializers.CharField(write_only=True, required=False, allow_blank=True)
...
def _decode_base64_image(b64: str) -> bytes:
    ...
    try:
        ...
        raise serializers.ValidationError({'sketch_base64': f'Base64 invalide : {e}'}) from e
