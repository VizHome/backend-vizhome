...
class CategorySerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = (
            ...
            'order', 'is_admin_only', 'topics_count', 'created_at',
        )
...
class TopicListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Topic
        fields = (
            'id', 'slug', 'title', 'author', 'category_slug', 'category_name',
            'is_pinned', 'is_locked',
...
class TopicDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = (
            'id', 'slug', 'author', 'category_slug', 'category_name',
            'is_pinned', 'is_locked',
            'views_count', 'replies_count', 'last_reply_at',
            'created_at', 'updated_at',
        )
...
class ReplySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Reply
        fields = (
            'id', 'topic', 'author', 'content', 'is_solution',
            'created_at', 'updated_at',
        )
        read_only_fields = (
            'id', 'topic', 'author', 'is_solution',
            'created_at', 'updated_at',
        )
